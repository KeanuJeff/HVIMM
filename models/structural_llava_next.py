...
import numpy as np
from transformers import LlavaNextForConditionalGeneration, AutoProcessor, AutoModelForCausalLM, BitsAndBytesConfig
import warnings
...
class HybirdLlavaFlorenceModel(nn.Module):
    ...
    def encode_structural_features(self, labels, fourier_features, centroids):
        ...
        final_tokens = self.rope_2d(combined, centroids)
